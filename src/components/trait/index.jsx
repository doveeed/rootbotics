...
const traitIdDescriptionMap = {
    ...
    'overwhelm': 'The Dig action requires and moves only three warriors (instead of four), and is repeated a second time each turn.',
    ...
    'spiteful': <>Whenever you <b>Crusade</b>, score <OneVP /> if you removed at least one token in any clearing.</>,
