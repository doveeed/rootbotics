...
const traitIdDescriptionMap = {
    ...
    'berserker': <>During the <b>Battle</b> action, target the clearing with the most pieces and target the player with the most pieces in that clearing. At the end of your turn, repair 1 additional item.</>,
