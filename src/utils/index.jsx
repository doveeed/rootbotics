...
export const CONSTANTS = {
    ...
    vagabotRiverfolkRiverBoatsText: <div style={{paddingLeft: '26px'}}><b>(Riverfolk)</b> If the Riverfolk player does not have more victory points than you do, treat rivers as paths. If at least one move would be shorter using a river, buy the River Boats service. <b>Do not exhaust an item and use Riverfolk Warriors to pay</b>.</div>,
